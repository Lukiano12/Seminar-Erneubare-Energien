...
\author{\IEEEauthorblockN{Dein Vorname Dein Nachname}
\IEEEauthorblockA{\textit{Fakultät/Department} \\
\textit{Name der Universität}\\
Stadt, Land \\
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{images/fig1.png}} % Ersetze fig1.png mit deinem Bild
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.45\textwidth]{images/fig1.png}} 
