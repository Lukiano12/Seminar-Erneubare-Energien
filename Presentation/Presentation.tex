...
\institute[THU]{Technische Hochschule Ulm (THU) \\ Electrical Energy Systems and Electromobility (M.Eng.)}
\date{\today}
...
\begin{frame}{Was lief gut? (Stärken)}
    ...
    \begin{block}{Sprache \& Formulierung}
        Einfache Stichpunkte konnten schnell in flüssige, akademische englische Absätze umgewandelt werden.
    \end{block}
