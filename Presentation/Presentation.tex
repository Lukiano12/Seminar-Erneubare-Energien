...
\begin{frame}{Einleitung \& Motivation}
    \textbf{Kontext:}
    \begin{itemize}
        \item Verfassen eines Seminar-Papers über die technischen Aspekte natürlicher und künstlicher Photosynthese (z. B. im IEEE-Format).
        \item Einsatz von Generativer KI (wie GitHub Copilot) als Schreib- und Codierassistenz.
    \end{itemize}
    \vspace{0.5cm}
    \textbf{Ziele dieses Kurzvortrags:}
    \begin{itemize}
        \item Konkrete Anwendungsfälle aus dem Schreibprozess zeigen.
        \item Bewertung der Werkzeuge: Stärken, Schwächen und Herausforderungen aufzeigen.
    \end{itemize}
\end{frame}
...
\begin{frame}{Wie habe ich die KI genutzt?}
    ...
    \begin{itemize}
        ...
        \item \textbf{Brainstorming von Analogien:} \\
              Hilfe bei der Übertragung biologischer Konzepte in ingenieurwissenschaftliche Begriffe (z. B. Thylakoidmembran als p-n-Übergang).
